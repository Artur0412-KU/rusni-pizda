...
export default function Stats() {
    ...
    const [animate, setAnumating] = useState<boolean>(true);
                ...
                {animate ? (
                    ...
                    <>
                        <List
                            ...
                            increase={
                                statistInfo?.data?.increase?.personnel_units
                            }
                        ...
                        <List
                            number={
                                statistInfo?.data?.stats
                                    ?.armoured_fighting_vehicles
                            }
                            title={
                                termsInfo?.data?.armoured_fighting_vehicles
                                    ?.title
                            }
                            increase={
                                statistInfo?.data?.increase
                                    ?.armoured_fighting_vehicles
                            }
                            image={
                                termsInfo?.data?.armoured_fighting_vehicles
                        ...
                        <List
                            ...
                            increase={
                                statistInfo?.data?.increase?.artillery_systems
                            }
                        ...
                        <List
                            number={
                                statistInfo?.data?.stats?.aa_warfare_systems
                            }
                            title={termsInfo?.data?.aa_warfare_systems?.title}
                            increase={
                                statistInfo?.data?.increase?.aa_warfare_systems
                            }
                        ...
                        <List
                            number={
                                statistInfo?.data?.stats?.vehicles_fuel_tanks
                            }
                            title={termsInfo?.data?.vehicles_fuel_tanks?.title}
                            increase={
                                statistInfo?.data?.increase?.vehicles_fuel_tanks
                            }
                        ...
                        <List
                            ...
                            increase={
                                statistInfo?.data?.increase?.warships_cutters
                            }
                        ...
                        <List
                            ...
                            increase={
                                statistInfo?.data?.increase?.cruise_missiles
                            }
                        ...
                        <List
                            ...
                            increase={
                                statistInfo?.data?.increase?.atgm_srbm_systems
                            }
